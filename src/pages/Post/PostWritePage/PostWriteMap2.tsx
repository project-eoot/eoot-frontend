// 오로지 출력만 하는 컴포넌트. 수정버튼 누르면 위로 수정하라고 올리기만 함
...
const PostWriteMap = ({ mapMarkers, handleMapMarker }) => {
  useEffect(() => {
    ...
    <div className="border-text-secondary border rounded-lg">
      <div className="relative rounded-t-lg">
        ...
        <div
          ...
          지도를 선택하는 곳이어요 지도가 있어요 지도에는 마크가 있어요
        </div>
        <div className="border-text-secondary bg-light p-2 rounded-b-lg border-t ">
          <div className="text-primary font-bold text-sm">멀티캠퍼스 역삼</div>
